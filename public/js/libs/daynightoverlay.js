 ...
 * atlas (i.e. the rectangular area from (90Ã‚Â°N,180Ã‚Â°W) to (90Ã‚Â°S,180Ã‚Â°E)).
...
DayNightOverlay.prototype.createTerminatorFunc_ = function(viewport, world) {
    ...
    // over the equator on the vernal and autumnal equinox, 23.44Ã‚Â° north at the
    // summer solstice and 23.44Ã‚Â° south at the winter solstice). Between those
